...
import { Separator, Container, PageRoot } from '@tpds/elements/layout'
  ...
  return (
    <PageRoot>
      <Container>
        ...
        <P>
          The Tempo Platform Design System provides a ready-to-use set of elements and components to make UI development
        ...
        <P>
          ...
          is a utility-first framework which generates a set of utility classes based on design tokens from our Design
          System created in Figma. This provides a reliable set of standards to ensure consistency across all Tempo
          Platform projects with the added benefit of a large active community as well as a great documentation site.
        </P>
        <br />
        <br />
      </Container>
...
function TailwindLogo() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='247' height='31' fill='none' viewBox='0 0 247 31'>
      <path
        fill='#38BDF8'
        fillRule='evenodd'
