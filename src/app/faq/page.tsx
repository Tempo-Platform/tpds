...
import { PSmall, H6 } from '@tpds/elements/typography'
    ...
    <PageRoot>
      <Container>
        ...
        <PSmall className='text-secondary'>
          ...
          <a href='https://www.npmjs.com/package/@tempoplatform/tpds'>@tempoplatform/tpds</a>. Then have a look at the
          elements and components pages to learn how to use the specific parts.
        </PSmall>
        <PSmall className='text-secondary'>
