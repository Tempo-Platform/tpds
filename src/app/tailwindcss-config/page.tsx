  ...
  return (
    <div>
      <Container>
        ...
        />
        <P>
          Grab this TailwindCSS configuration JSON to quickly strap up a new project using the Tempo design system
          design tokens.
        </P>
        <br />
        <P>
          Create a new file with the name <span tw='font-mono'>tailwind.config.js</span> in the root of your project to
          quickly strap up a new project and paste the below configuration in it.
        </P>
        <br />
        <P>
          Follow the{' '}
