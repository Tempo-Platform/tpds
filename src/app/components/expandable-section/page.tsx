...
export default function Page() {
  return (
    <div>
      <Container>
        <PageHeader title='Expandable Section' subTitle='A box that expands and contracts on tap.' />
        <P>An expandable box that opens and closes by clicking or tapping the top area.</P>
        <br />
        <P>
          When opening it automatically moves to the (vertical) center of the screen if it would otherwise would open
          fully or partially outside of the viewable area of the screen.
        </P>
        <br />
        <P>
          It can optionally take the ID of a DOM element to take into account when calculating the available vertical
          area (available height will be screen height minus the element's height).
        </P>
        <br />
        <br />
