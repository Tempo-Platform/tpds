...
const tableColumns = [
  ...
  },
  {
    ...
    enableSort: true,
    render: (item: any) => {
      return <Tag label={item.name} variant={getTagVariant(item.state)} className='inline-flex self-start' />
    },
  },
  {
    label: 'Quantity',
  ...
  return (
    <div>
      <Container>
        ...
        <PSmall>- Every cell of a specific column can take additional classes, for styling or other purposes</PSmall>
        <PSmall>- Dark / Light mode ready</PSmall>
        <PSmall>- Pagination can be enabled / disabled, in the latter case all items will be displayed</PSmall>
        <PSmall>- Current page and items per page can be passed on instantiation (when pagination is enabled)</PSmall>
        <PSmall>
        ...
        <PropsTable
          items={[
            ...
            },
            {
              ...
              default: 'true',
              required: 'no',
              description: 'If true, pagination will be enabled. If false, all items will be displayed.',
            },
            {
              propName: 'router',
              type: 'Component',
              default: 'null',
              required: 'no',
              description: 'Only required when pagination is active. Used to navigate between pages.',
            },
            {
              ...
              default: '10',
              required: 'no',
              description: 'The number of items to be displayed per page. Only used when pagination is enabled.',
            },
            {
              propName: 'rowClick',
              type: 'Boolean',
              default: 'null',
              required: 'no',
              description: 'If true, the entire row will be clickable. An hover effect will be added.',
            },
            {
              propName: 'page',
              type: 'Number',
