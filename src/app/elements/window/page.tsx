  ...
  return (
    <PageRoot>
      <Container>
        ...
        <P>
          The Window is a dark-mode enabled component. It automatically applies the standard window color and has
          resposive padding out of the box.
        </P>
        <br />
        <br />
        <div className='bg-body p-20'>
          <Window>
            ...
            <br />
            <P>
              The Window component also has a thin border around it, and rounded corners that become tighter in smller
              screens.
            </P>
          </Window>
        </div>
