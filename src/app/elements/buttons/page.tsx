  ...
  return (
    <div>
      <Container>
        ...
        <br />
        <br />
        <CodeGridComponent code={codeSuccess} element={<Button variant='success'>Success</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeInfo} element={<Button variant='info'>Info</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeWarning} element={<Button variant='warning'>Warning</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeDanger} element={<Button variant='danger'>Danger</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeSpecial} element={<Button variant='special'>Special</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeContrast} element={<Button variant='contrast'>Contrast</Button>} />
        <br />
        <br />
        <CodeGridComponent code={codeContrastGhost} element={<Button variant='contrastghost'>Contrast Ghost</Button>} />
        <br />
        <br />
        <br />
        <br />
        ...
        <br />
        <P>
          The <Bold>disabled</Bold> button variant is an option available in all variants, to be used when, for example,
          a user needs to fill out a form before submitting. The button becomes transparent and pointer-events are
          disabled.
        </P>
        <br />
        <Separator />
        ...
        <br />
        <P>
          The sizes <Bold>tiny</Bold>, <Bold>small</Bold>, <Bold>large</Bold> and <Bold>extra large</Bold> are available
          in all variants.
        </P>
        <br />
        <Separator />
