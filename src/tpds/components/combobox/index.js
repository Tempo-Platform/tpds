...
//               />
//             )}
//             <SelectorIcon tw="w-5 h-5 text-tertiary" aria-hidden="true" />
//           </Combobox.Button>
//         </div>
...
//                     <span css={spanStyles[active]}>{item.label}</span>
//                     {selected ? (
//                       <span css={spanBStyles[active]}>
...
// spanStyles[
//   true
// ] = tw`block truncate font-medium px-4 pl-10 py-2 bg-grey-light-scale-500/10 hover:cursor-pointer`
// spanStyles[false] = tw`block truncate font-normal px-4 pl-10 py-2 hover:cursor-pointer`
// const spanBStyles = {}
// spanBStyles[
//   true
// ] = tw`absolute inset-y-0 left-0 top-0 flex items-center pl-3 text-green text-current`
// spanBStyles[
//   false
