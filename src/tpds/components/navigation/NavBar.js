...
// import HummingbotLogo from '../../assets/svgs/logos/TempoLogo'
...
//           {processLogo()}
//           <NavMobileH4 tw="pl-xxs font-medium leading-none">
//             {siteNameA} <span tw="ml-[4px] font-thin">{siteNameB}</span>
//           </NavMobileH4>
//         </div>
//         <br />
//         <br />
...
// const FirstLevelItem = styled.div(() => [tw`mr-5`])
...
// const LinksLeft = styled.div(() => [tw`hidden lg:flex items-center`])
...
// const Menu = styled.div(() => [tw`flex cursor-pointer h-[32px] items-center`])
...
//   return (
//     <svg xmlns="http://www.w3.org/2000/svg" width="13" height="14" viewBox="0 0 13 14" tw="ml-xs">
//       <path
//         tw="fill-current"
...
//       <path d="M8.777 7H28.888999999999996V9.514H8.777z" transform="rotate(45 8.777 7)"></path>
//       <path d="M7.001 21.222H27.113V23.736H7.001z" transform="rotate(-45 7.001 21.222)"></path>
//     </svg>
//   )
// }
