...
const SpacingsPage = () => (
  <Layout>
    <Hero tw="bg-window border-b-2 border-grey-light-scale-400 dark:border-grey-dark-scale-200">
      <H1 isMedium>Spacings</H1>
      <P>The most commonly used spacings</P>
    </Hero>
    <MainContent>
      <P>
        These spaces are available in all spacing classes, such as margins, paddings, left, right,
        top, bottom. Examples: <Bold>m-xs</Bold> (margin xs), <Bold>mb-xs</Bold> (margin-bottom xs),{' '}
        <Bold>pt-xs</Bold> (padding-top xs), <Bold>left-xs</Bold> (position left xs),{' '}
        <Bold>top-xs</Bold> (position top xs).
      </P>
      <Separator />
      <br />
