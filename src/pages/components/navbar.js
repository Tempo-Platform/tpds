...
const Navigation = () => (
  <Layout>
    ...
    <MainContent>
      ...
      <br />
      <P><Bold>siteNameB:</Bold> (string) (optional) extra label to append to the main label - for example "Platform" in "Tempo Platform". This will be showin in a thinner font style.</P>
      <br />
      <P><Bold>logo:</Bold> (string) default is "Tempo".</P>
      <br />
      ...
      <P tw='pl-sm'><Medium>buttonStyle</Medium> (string) - can be "success", "info" or "secondary"</P>
      <br />
