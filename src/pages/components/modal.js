...
import { H1, P, PLarge, PSmall } from '../../../tpds/elements/typography'
...
const ModalPage = () => (
  <Layout>
    ...
    <MainContent>
      ...
      <br />
      <P>
        Multiple "options" (buttons) can be configured. Each button can take an optional callback
        function.
      </P>
      <br />
      <P>
        If no options are passed to the Modal, it will automatically generate a single "Close"
        option, that simply closes the Modal.
      </P>
      <br />
      <br />
      <br />
      ...
      <Modal
        ...
        content={
          <P>
            Your application has been successfully submitted. Please review your order and if all
            looks good, click "Accept" to proceed.
          </P>
        }
        options={[
          {
        ...
        clickElement={<Button variant="success">Open modal</Button>}
      />
      <br />
      <br />
      ...
      <br />
      <PLarge>
        Example triggered with button, without providing any button options: A "Close" button is
      ...
      <Modal
        title="Modal title"
        description="Description of the modal context or purpose"
        content={<P>Your application has been successfully submitted.</P>}
        clickElement={<Button variant="success">Open modal</Button>}
      />
      <br />
      <br />
...
const codeWithTwoOptions = String.raw`import Modal from '@tempoplatform/tpds/components/modal'
...
const codeWithoutOptions = String.raw`import Modal from '@tempoplatform/tpds/components/modal'
import { P } from '@tempoplatform/tpds/elements/typography'
import { Button  } from '@tempoplatform/tpds/elements/buttons'
...
const codeWithoutClickElement = String.raw`import Modal from '@tempoplatform/tpds/components/modal'
import { P } from '@tempoplatform/tpds/elements/typography'
