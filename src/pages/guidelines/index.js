...
const GuidelinesIndex = () => (
  <Layout>
    ...
    <MainContent>
      <br />
      <br />
      <PLarge>The Tempo Platform Design System reflects the patterns and components that underpin the Tempo Platform products. These patterns and components provide a unified language and consistent look and feel when designing apps and products within the Tempo Platform.</PLarge>
      <br />
      <br />
