...
import { H1, P, PLarge, H6, H5 } from '../../../tpds/elements/typography'
...
const GuidelinesIndex = () => (
  <Layout>
    ...
    <MainContent>
      ...
      <br />
      <PLarge>
        These principles form the foundation of our design system. They guide our team when working
        on different parts of the system and help us do better and more informed decisions.
      </PLarge>
      <br />
      ...
      <P>
        We should use the same language and design patterns wherever possible. This helps people get
        familiar with our services. Same holds true for the system and its developer experience.
      </P>
      <br />
      <br />
      ...
      <P>
        Our services are for everyone. We make sure people with different needs can use our products
        and that they meet the accessibility standards.
      </P>
      <br />
      <br />
      <H6 isBold>Provide a good developer experience</H6>
      <P>
        Providing a good developer experience is very important to us. Developers should be able to
        start using our tools in minutes, not hours, days or weeks.
      </P>
      <br />
      <br />
