...
import { H1, P, H6, LabelTiny, PSmall } from '../../../tpds/elements/typography'
import { Separator, Section, Container, Window } from '../../../tpds/elements/layout'
...
const DarkMode = () => (
  <Layout>
    ...
    <MainContent>
      <P>
        The Tempo Platform Design System provides an automatic dark mode out of the box. By applying
        the TailwindCSS classes correctly, the UI will adapt to the current color scheme.
      </P>
      <br />
      <P>
      ...
      <br />
      <DarkModeBg tw="p-8">
        <PWhite>Body bg: {colorTokens.dark.body_bg}</PWhite>
        <PWhite>Body border: {colorTokens.dark.body_border}</PWhite>
        <DarkModeWindow tw="w-[50%] p-8 my-10 mx-auto">
          <PWhite>Window bg: {colorTokens.dark.window_bg}</PWhite>
          <PWhite>Window border: {colorTokens.dark.window_border}</PWhite>
          <br />
      ...
      <br />
      <P>
        It is useful to know how to achieve the same "by hand". The following code would produce the
        same effect:
      </P>
      <br />
      ...
      <br />
      <P>
        The class <Code>text-primary</Code> tells the element to assume the current scheme's primary{' '}
        <Underline>text color</Underline>.
      </P>
      <P>
      ...
      <br />
      <P isBold>Text</P>
      <P tw="text-magenta dark:text-blue">
      ...
      <br />
      <P isBold>Text</P>
      <P tw="text-[#ff0000] dark:text-[#00ff00]">
...
const Code = styled.span(() => [tw`font-mono font-bold`])
const Underline = styled.span(() => [tw`underline`])
