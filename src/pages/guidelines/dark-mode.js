...
const DarkMode = () => (
  <Layout>
    ...
    <MainContent>
      <P>The Tempo Platform Design System provides an automatic dark mode out of the box. By applying the TailwindCSS classes correctly, the UI will adapt to the current color scheme.</P>
      <br />
      ...
      <br />
      <P>You should use TPDS's layout elements to achieve this effect systematically. The required classes have already been added for you, saving you time and possible errors.</P>
      <br />
