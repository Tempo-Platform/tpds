...
import { P, PSmall, PTiny, H1, H2, H4, H6, H5, LabelTiny } from '../../../tpds/elements/typography'
  ...
  <Layout>
    ...
    <MainContent>
      ...
      <CalloutInfo
        ...
        text={
          <span>
            Get access to our font pack in the <Link to="/downloads#typography">downloads</Link>{' '}
            section.
          </span>
        }
      />
