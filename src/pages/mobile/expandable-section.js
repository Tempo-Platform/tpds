  ...
  return (
    <Layout>
      <Hero tw='bg-window border-b-2 border-grey-light-scale-400 dark:border-grey-dark-scale-200'>
        <H1 isMedium tw='leading-tight'>Expandable Section</H1>
      ...
      <MainContent>
        ...
        <br />
        <P>When opening it automatically moves to the (vertical) center of the screen if it would otherwise would open fully or partially outside of the viewable area of the screen.</P>
        <br />
        <P>It can optionally take the ID of a DOM element to take into account when calculating the available vertical area (available height will be screen height minus the element's height).</P>
        <br />
        <br />
        <ExpandableSection
            title='Box title'
      ...
      <PropsTable
        ...
        items={[
          ...
          },
          {
            ...
            default: "null",
            required: 'optional',
            description: "ID of a DOM element to take it's height into account when calculating if the box will be fully visible after opening."
          },
          {
