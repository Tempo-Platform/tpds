      ...
      <Container>
        <PaddingBox>
          <P>
            ...
            applying the TailwindCSS classes correctly, the UI will adapt to the current color
            scheme.
          </P>
          <br />
          <P>
          ...
          <br />
          <P>
            You should use TPDS's layout elements to achieve this effect systematically. The
            required classes have already been added for you, saving you time and possible errors.
          </P>
          <br />
          ...
          <br />
          <P>
            It is also possible to achieve completely custom colors per color scheme. See the
            example below:
          </P>
          <br />
          <br />
