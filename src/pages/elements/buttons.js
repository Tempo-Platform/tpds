...
const Buttons = () => (
  <Layout>
    ...
    <MainContent>
      ...
      <br />
      <P>
        The <Bold>disabled</Bold> button variant is an option available in all variants, to be used
        when, for example, a user needs to fill out a form before submitting. The button becomes
        transparent and pointer-events are disabled.
      </P>
      <br />
      <Separator />
      <br />
