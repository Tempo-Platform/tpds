...
import { P, Bold, H6, H1, Red, Blue, Green } from '../../../tpds/elements/typography'
import { red, green, blue, purple, orange } from '../../../tpds/constants/colors'
import colors from '../../../tpds/constants/colors'
import {
  PageRoot,
  Section,
  Container,
...
const LayoutCore = () => (
  <Layout>
    ...
    <MainContent>
      <P>
        The single column layout is the simplest layout and consists of a single central column
        housing all the content.
      </P>
      <br />
      <Separator />
      <br />
      ...
      <br />
      <P>
        Placed at the root of a page, ensures the page always takes the full height of the browser
        window. A great way to ensure the correct background color fills the screen.
      </P>
      <br />
      <P isBold>Section</P>
      <br />
      <P>
        Takes the full width of the screen, and is ready to handle a <Bold>Container</Bold> inside.
      </P>
      <br />
      <P isBold>Container</P>
      <br />
      <P>
        Is the central column, within a single-column layout. <Bold>Responsive</Bold> by default.
      </P>
      <br />
      <br />
      <br />
      ...
      <br />
      <P>
        Resize the browser to see the interplay between <Green>PageRoot</Green>, <Red>Section</Red>{' '}
        and <Blue>Container</Blue>:
      </P>
      <br />
      <P>
        (Note how the <Green>PageRoot</Green> takes the full screen height, the <Red>Section</Red>{' '}
        the full width, and the <Blue>Container</Blue> a constrained central position.)
      </P>
      <br />
        ...
        <Section style={{ border: `2px solid ${red}` }}>
          <Container style={{ border: `2px solid ${blue}` }}>
            <P>
              ...
              commodo cursus magna, vel scelerisque nisl consectetur et. Curabitur blandit tempus
              porttitor.
            </P>
          </Container>
        </Section>
      ...
      <br />
      <P>
        The sidebar layout consists of a sidebar on the left side together with a single column
      ...
      <br />
      <P>
        Placed at the root of a sidebar layout page, handles the containment of{' '}
        <Bold>SBLRootSidebar</Bold> and <Bold>SBLRootContent</Bold>.
      </P>
      <br />
      <P isBold>SBLRootSidebar</P>
      <br />
      <P>
        The container for the content in the sidebar, such as navigation. This element will be
        hidden in small screens (mobile) and should be replaced with a mobile navigation.
      </P>
      <br />
      <P isBold>SBLRootContent</P>
      <br />
      <P>
        The container where the main content will be placed. A <Red>Section</Red> and{' '}
        <Blue>Container</Blue> elements should be placed inside this element to ensure correct
        responsive behavior.
      </P>
      <br />
      <P>
        Resize the browser to see the responsive behavior in action. Also, note how the layout takes
        the height of your browser window, and how the content area is scroolable.
      </P>
      <br />
          ...
          <Section style={{ border: `2px solid ${red}` }}>
            <Container style={{ border: `2px solid ${blue}` }}>
              ...
              <P>
                ...
                Maecenas sed diam eget risus varius blandit sit amet non magna. Integer posuere erat
                a ante venenatis dapibus posuere velit aliquet. Donec ullamcorper nulla non metus
                auctor fringilla. Nullam id dolor id nibh ultricies vehicula ut id elit.
              </P>
              <br />
              <P>
                ...
                faucibus dolor auctor. Aenean eu leo quam. Pellentesque ornare sem lacinia quam
                venenatis vestibulum. Cum sociis natoque penatibus et magnis dis parturient montes,
                nascetur ridiculus mus.
              </P>
              <br />
              <P>
                Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras mattis consectetur
                purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris
                condimentum nibh, ut fermentum massa justo sit amet risus. Aenean lacinia bibendum
                nulla sed consectetur.
              </P>
              <br />
              <P>
                Donec id elit non mi porta gravida at eget metus. Etiam porta sem malesuada magna
                mollis euismod. Aenean lacinia bibendum nulla sed consectetur. Fusce dapibus, tellus
                ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet
                risus. Donec sed odio dui. Maecenas faucibus mollis interdum.
              </P>
              <br />
              <P>
                ...
                parturient montes, nascetur ridiculus mus. Duis mollis, est non commodo luctus, nisi
                erat porttitor ligula, eget lacinia odio sem nec elit. Duis mollis, est non commodo
                luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.
              </P>
              <br />
              <P>
                Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Nullam quis
                risus eget urna mollis ornare vel eu leo. Donec sed odio dui. Lorem ipsum dolor sit
                amet, consectetur adipiscing elit. Morbi leo risus, porta ac consectetur ac,
              ...
              <P>
                ...
                et. Donec id elit non mi porta gravida at eget metus. Curabitur blandit tempus
                porttitor. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh,
                ut fermentum massa justo sit amet risus. Maecenas sed diam eget risus varius blandit
                sit amet non magna.
              </P>
              <br />
              <P>
                Sed posuere consectetur est at lobortis. Donec sed odio dui. Aenean lacinia bibendum
                nulla sed consectetur. Donec sed odio dui. Praesent commodo cursus magna, vel
                scelerisque nisl consectetur et. Nulla vitae elit libero, a pharetra augue. Vivamus
              ...
              <P>
                ...
                metus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis
              ...
              <P>
                ...
                ullamcorper nulla non metus auctor fringilla. Morbi leo risus, porta ac consectetur
                ac, vestibulum at eros. Sed posuere consectetur est at lobortis. Duis mollis, est
              ...
              <P>
                ...
                sem nec elit. Donec ullamcorper nulla non metus auctor fringilla. Aenean eu leo
                quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Cras mattis
                consectetur purus sit amet fermentum. Sed posuere consectetur est at lobortis. Etiam
...
const codeSideBarLayout = String.raw`import { SBLRoot, SBLRootSidebar, SBLRootContent, Section, Container } from '@tempoplatform/tpds/elements/layout'
import { P } from '@tempoplatform/tpds/elements/typography'
