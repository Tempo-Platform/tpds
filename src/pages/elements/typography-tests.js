...
const codeLabel = String.raw`import { Label } from '@tempoplatform/tpds/elements/typography'

<Label>sdfsfsd</Label>
`

const codeLabelSmall = String.raw`import { LabelSmall } from '@tempoplatform/tpds/elements/typography'

<LabelSmall>sdfsfsd</LabelSmall>
`

const codeLabelNano = String.raw`import { LabelNano } from '@tempoplatform/tpds/elements/typography'

<LabelNano>sdfsfsd</LabelNano>
`

const codeLabelTiny = String.raw`import { LabelTiny } from '@tempoplatform/tpds/elements/typography'
...
`
const codeParagraphSmall = String.raw`import { PSmall } from '@tempoplatform/tpds/elements/typography'

<PSmall>The quick brown fox jumps over the lazy dog</PSmall>
`
const codeParagraphTiny = String.raw`import { PTiny } from '@tempoplatform/tpds/elements/typography'

<PTiny>The quick brown fox jumps over the lazy dog</PTiny>
`
const codeParagraphNano = String.raw`import { PNano } from '@tempoplatform/tpds/elements/typography'
...
`
const codeH5 = String.raw`import { H4 } from '@tempoplatform/tpds/elements/typography'

<H4>The quick brown fox jumps over the lazy dog</H4>
`
const codeH4 = String.raw`import { H4 } from '@tempoplatform/tpds/elements/typography'

<H4>The quick brown fox jumps over the lazy dog</H4>
`
const codeH3 = String.raw`import { H3 } from '@tempoplatform/tpds/elements/typography'

<H3>The quick brown fox jumps over the lazy dog</H3>
`
const codeH2 = String.raw`import { H2 } from '@tempoplatform/tpds/elements/typography'

<H2>The quick brown fox jumps over the lazy dog</H2>
`
const codeH1 = String.raw`import { H1 } from '@tempoplatform/tpds/elements/typography'
