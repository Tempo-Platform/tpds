...
function DSMSidebar({...props}) {
  return (
    <div {...props} tw='relative'>
      <Sidebar>
        <a tw='block flex justify-end' href='https://github.com/Tempo-Platform/tpds' target='_blank' rel='noreferrer'>
          <GithubIcon />
        </a>
        <SidebarBrand>
...
const Sidebar = styled.div(() => [
  tw`bg-window p-2 lg:p-5 border-r border-grey-light-scale-400 dark:border-grey-dark-scale-200`,
  css`
    overflow-y: scroll;
    height: 100vh;
  `,
