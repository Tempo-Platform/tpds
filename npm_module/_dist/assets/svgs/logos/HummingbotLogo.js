...
var tinySize = [(0, _styledComponents.css)(_templateObject || (_templateObject = (0, _taggedTemplateLiteralLoose2["default"])(["\n    width: 27px;\n    height: 23px;\n  "])))];
var smallSize = [(0, _styledComponents.css)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteralLoose2["default"])(["\n    width: 40px;\n    height: 32px;\n  "])))];
var mediumSize = [(0, _styledComponents.css)(_templateObject3 || (_templateObject3 = (0, _taggedTemplateLiteralLoose2["default"])(["\n    width: 55px;\n    height: 48px;\n  "])))];
var largeSize = [(0, _styledComponents.css)(_templateObject4 || (_templateObject4 = (0, _taggedTemplateLiteralLoose2["default"])(["\n    width: 90px;\n    height: 80px;\n  "])))];
var hugeSize = [(0, _styledComponents.css)(_templateObject5 || (_templateObject5 = (0, _taggedTemplateLiteralLoose2["default"])(["\n    width: 140px;\n    height: 130px;\n  "])))];
var logoSizes = {
  tiny: tinySize,
  small: smallSize,
  medium: mediumSize,
...
function HummingbotLogo(_ref2) {
  var props = Object.assign({}, ((0, _objectDestructuringEmpty2["default"])(_ref2), _ref2));
  var colors = primaryColors;
  if (props.colorStyle === 'terminal') {
    colors = terminalColors;
  }
  if (props.colorStyle === 'white-black') {
    colors = wbColors;
  }
  if (props.colorStyle === 'black-white') {
    colors = bwColors;
  }
  return /*#__PURE__*/_react["default"].createElement(LogoSVG, Object.assign({}, props, {
