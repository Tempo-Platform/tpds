...
function Spinner({
  ...
  return <>
      ...
      <svg {...props} className="tpds-spinner" viewBox="0 0 42 42" style={{
      ...
      height: `${radius ? radius : 40}px`
        ...
        <g fill="none" transform="translate(3 3)" strokeWidth={strokeWidth}>
          <circle className="stroke-grey-light-scale-400 dark:stroke-grey-dark-scale-300" cx="18" cy="18" r="18" />
          <path className="stroke-current text-primary" style={{
          color: color
        }} stroke="currentColor" d="M36 18c0-9.94-8.06-18-18-18" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </>;
}
