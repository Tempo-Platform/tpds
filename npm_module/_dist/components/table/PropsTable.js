...
function PropsTable({
  ...
  return <div>
      ...
      <span className="grid grid-cols-12 gap-4 pb-2 mb-8 border-b border-grey-light-scale-500 dark:border-grey-light-scale-900">
        ...
        {!skipColumn2 && <P isBold className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
            {col2Name}
          </P>}
        {!skipColumn3 && <P isBold className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
            {col3Name}
          </P>}
        {!skipColumn4 && <P isBold className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
            {col4Name}
          </P>}
      ...
      {items.map((item, index) => <span className="grid grid-cols-12 gap-4 mb-4" key={index}>
          <P className="col-span-2" isBold>
            {item[param1Name]}
          </P>
          {!skipColumn2 && <P className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
              {item[param2Name]}
            </P>}
          {!skipColumn3 && <P className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
              {item[param3Name]}
            </P>}
          {!skipColumn4 && <P className="whitespace-nowrap text-ellipsis overflow-hidden col-span-2">
              {item[param4Name]}
            </P>}
