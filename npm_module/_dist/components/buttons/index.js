...
export function ExternalLinkButton({
  ...
  return <Button variant={props.variant || 'default'} label={label} iconAfter={<ExternalLinkIcon />} {...props} />;
}