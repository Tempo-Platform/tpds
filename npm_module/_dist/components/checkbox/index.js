...
function Checkbox({
  ...
  return <div className={finalRootClassName} {...props}>
...
function CheckIcon({
  ...
  return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="10" height="8" fill="currentColor" viewBox="0 0 8 6">
      <path fill="currentColor" d="M7.25 1.266c.25-.25.25-.641 0-.891a.632.632 0 00-.875 0L2.812 3.938 1.25 2.375a.632.632 0 00-.875 0c-.25.25-.25.64 0 .89l2 2c.11.126.281.188.438.188a.617.617 0 00.437-.187l4-4z"></path>
    </svg>;
}
function MinusIcon({
  ...props
}) {
  return <svg {...props} xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10">
