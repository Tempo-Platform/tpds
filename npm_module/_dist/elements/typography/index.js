...
export const H6 = props => {
  const finalClass = calculateFinalClass('text-base md:text-lg lg:text-xl xl:text-2xl tracking-normal leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
export const H5 = props => {
  const finalClass = calculateFinalClass('text-lg md:text-xl lg:text-2xl xl:text-3xl tracking-normal leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
export const H4 = props => {
  const finalClass = calculateFinalClass('text-xl md:text-2xl lg:text-3xl xl:text-4xl tracking-normal leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
export const H3 = props => {
  const finalClass = calculateFinalClass('text-2xl md:text-3xl lg:text-4xl xl:text-5xl tracking-tight leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
export const H2 = props => {
  const finalClass = calculateFinalClass('text-3xl md:text-4xl lg:text-5xl xl:text-6xl tracking-tight leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
export const H1 = props => {
  const finalClass = calculateFinalClass('text-4xl md:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-tight', props);
  return <p className={finalClass} style={props.style}>
      {props.children}
    </p>;
};
...
export const AccentColor = props => {
  ...
  return <span className={finalClass} style={props.style}>
      {props.children}
    </span>;
};
...
export const FormLabelNano = props => {
  return <PNano className="font-label text-tertiary font-medium leading-none">{props.children}</PNano>;
};
export const FormLabelTiny = props => {
  return <PTiny className="font-label text-tertiary font-medium leading-none">{props.children}</PTiny>;
};
export const FormLabelSmall = props => {
  return <PSmall className="font-label text-tertiary font-medium leading-none">{props.children}</PSmall>;
};
