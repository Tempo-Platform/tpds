...
var baseInputStyles = ['flex w-full', 'transition duration-100', 'px-2.5 py-1 rounded focus:outline-none', 'font-normal', '!h-[36px]', 'bg-input', 'border-transparent', 'text-primary', 'border-2 focus:border-black dark:focus:border-white'];
exports.baseInputStyles = baseInputStyles;
var outlineStyles = ['bg-transparent !border-[#ededed] focus:!border-black dark:focus:!border-white dark:!border-[#384147] dark:focus:!border-blue'];
