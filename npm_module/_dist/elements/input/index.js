...
var baseInputStyles = ['flex w-full', 'transition duration-100', 'px-2.5 py-1 rounded focus:outline-none', 'font-normal', 'bg-input', 'border-transparent', 'text-primary', 'border-2 focus:border-blue'];
