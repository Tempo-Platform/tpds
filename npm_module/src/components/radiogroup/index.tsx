        ...
        return (
          <div
            ...
            className={clsx(
              ...
              isActive ? `bg-grey-light-scale-200 dark:bg-grey-dark-scale-300` : `bg-[#ffffff] dark:bg-[#1E2224]`,
              lightOnly && '!border-[#E9EBEC] !bg-[#ffffff]',
              isActive && lightOnly && '!bg-grey-light-scale-200',
            )}
            onClick={handleIndexSelection ? () => handleIndexSelection(index) : undefined}
          >
            <div className='flex flex-col gap-y-2 w-[calc(100%-40px)]!'>
              <PSmall isMedium className={clsx('capitalize leading-none', lightOnly && '!text-[#151819]')}>
                {option.title}
              </PSmall>
              <PSmall className={clsx('text-secondary leading-tight', lightOnly && '!text-[#788187]')}>
                {option.description}
              </PSmall>
            </div>
            <div
              className={clsx(
                ...
                `transition-all duration-300`,
                !lightOnly && `bg-transparent border-grey-light-scale-300 dark:border-grey-dark-scale-300`,
            ...
            >
              {isActive && (
                <CheckIcon
                  className={clsx(
                    lightOnly ? 'text-white relative top-0' : 'text-white relative top-0 dark:text-black',
                  )}
                />
              )}
            </div>
