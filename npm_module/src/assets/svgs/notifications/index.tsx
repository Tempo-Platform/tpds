...
export function BugIcon({ className = 'text-orange', style, onClick }: IconProps) {
  return (
    <svg
...
export function CheckIcon({ className = 'text-green', style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
...
export function ErrorIcon({ className = 'text-red', style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='14'
...
export function InfoIcon({ className = 'text-blue', style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
      ...
      style={style}
    >
      <path fill='currentColor' d='M8 16A8 8 0 108 0a8 8 0 000 16z'></path>
      <path
        fill='#fff'
...
export function NoteIcon({ className, style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
      ...
      style={style}
    >
      <path fill='#767676' d='M14 0H2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2z'></path>
      <path fill='#fff' d='M13 3H3v1h10V3zM13 6H3v1h10V6zM13 9H3v1h10V9zM13 12H3v1h10v-1z'></path>
    </svg>
  )
}

export function TipIcon({ className = 'text-purple', style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
      ...
      style={style}
    >
      <path fill='currentColor' d='M14 0H2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V2a2 2 0 00-2-2z'></path>
      <path
        fill='#fff'
...
export function WarningIcon({ className = 'text-orange', style, onClick }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='18'
      ...
      style={style}
    >
      <path fill='currentColor' d='M.75 14.75h16.5L9 .5.75 14.75zm9-2.25h-1.5V11h1.5v1.5zm0-3h-1.5v-3h1.5v3z'></path>
    </svg>
  )
}
