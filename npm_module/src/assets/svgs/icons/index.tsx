...
export function CheckIcon({ ...props }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='11' height='9' viewBox='0 0 11 9' fill='none' {...props}>
      <path
        fill='currentColor'
...
export function MinusIcon({ ...props }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='44' height='44' viewBox='0 0 44 44' fill='currentColor' {...props}>
