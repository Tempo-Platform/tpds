...
export function ArrowLeftIcon({ ...props }) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' width='10' height='19' fill='none' viewBox='0 0 10 19'>
      <path
        fill='currentColor'
...
export function ArrowDownIcon({ ...props }) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' width='18' height='11' fill='none' viewBox='0 0 18 11'>
      <path
        fill='currentColor'
...
export function ArrowUpIcon({ ...props }) {
  return (
    <svg {...props} xmlns='http://www.w3.org/2000/svg' width='18' height='10' fill='none' viewBox='0 0 18 10'>
      <path
        fill='currentColor'
