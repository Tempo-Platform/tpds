...
const PNano = (props) => {
    ...
    return (/*#__PURE__*/React.createElement("p", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const PTiny = (props) => {
...
const H6 = (props) => {
    ...
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("h6", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const H5 = (props) => {
    const finalClass = calculateFinalClass(h5Class, props);
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("h5", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const H4 = (props) => {
    const finalClass = calculateFinalClass(h4Class, props);
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("h4", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const H3 = (props) => {
    const finalClass = calculateFinalClass(h3Class, props);
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("h3", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const H2 = (props) => {
    const finalClass = calculateFinalClass(h2Class, props);
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("h2", Object.assign({}, xprops, { className: finalClass, style: props.style, onClick: props.onClick }), "\n      ", props.children, "\n    "));
};
const H1 = (props) => {
    const finalClass = calculateFinalClass(h1Class, props);
    return (/*#__PURE__*/React.createElement("h1", { className: finalClass, style: props.style, onClick: props.onClick }, "\n      ", props.children, "\n    "));
};
// // helpers
const AccentColor = (props) => {
    const finalClass = calculateFinalClass('!text-blue', props);
    const xprops = { id: props.id };
    return (/*#__PURE__*/React.createElement("span", Object.assign({}, xprops, { className: finalClass, style: props.style }), "\n      ", props.children, "\n    "));
};
const Bold = (props) => {
