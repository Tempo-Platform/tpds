...
customRowClass, customHeaderClass, }) {
    ...
    const headerClass = clsx('grid gap-2', columnVariants[columns.length], 'px-4 py-1.5', 'border-b border-grey-light-scale-300 dark:border-grey-dark-scale-600');
    const rowClass = clsx('grid gap-4', 'px-4', columnVariants[columns.length], 'border-b border-grey-light-scale-200 dark:border-grey-dark-scale-700', rowClick && 'cursor-pointer hover:bg-zinc-100/50 dark:hover:bg-zinc-900/50', density === 'high' && 'py-2', density === 'medium' && 'py-3', density === 'low' && 'py-4', 
    ...
    return (/*#__PURE__*/React.createElement("div", null, "\n      ", /*#__PURE__*/React.createElement("div", { className: headerClass }, "\n        ", columns.map((column, columnIndex) => (/*#__PURE__*/React.createElement(elements_typography_index.PTiny, { isMedium: true, key: `column-${columnIndex}`, className: clsx('select-none whitespace-nowrap text-ellipsis overflow-hidden flex gap-x-2 items-center', column.enableSort && 'cursor-pointer', customHeaderClass), style: {
                ...
                : undefined }, "\n            ", column.label, ' ', "\n            ", sortByColumn && sortByColumn.propName === column.propName && (/*#__PURE__*/React.createElement(assets_svgs_arrows_index.TriangleDown, { className: 'inline-block ml-1', style: { transform: sortDirection === 1 ? '' : 'rotate(180deg)' } })), "\n          "))), "\n      "), "\n      ", /*#__PURE__*/React.createElement("div", { className: rowsContainerClass }, "\n        ", data.map((item, rowIndex) => (/*#__PURE__*/React.createElement("div", { key: `row-${rowIndex}`, className: rowIndex === data.length - 1
                ? clsx(rowClass, '!border-grey-light-scale-300 dark:!border-grey-dark-scale-600')
                : rowClass, onClick: rowClick ? () => rowClick(item) : undefined }, "\n            ", columns.map((column, elementIndex) => {
                return renderElement(item, column, rowIndex, elementIndex);
            }), "\n          "))), "\n      "), "\n      ", showPagination && (/*#__PURE__*/React.createElement("div", { className: 'flex justify-end gap-1' }, "\n          ", /*#__PURE__*/React.createElement(elements_buttons_index.Button, { className: '!p-2 min-w-0 text-primary', variant: 'default', isDisabled: page === 1, isSmall: true, onClick: handleBackToFirstPage }, "\n            ", /*#__PURE__*/React.createElement(BeginningIcon, null), "\n          "), "\n          ", /*#__PURE__*/React.createElement(elements_buttons_index.Button, { className: '!p-2 min-w-0 text-primary', variant: 'default', isDisabled: page === 1, isSmall: true, onClick: handleClickToPreviousPage }, "\n            ", /*#__PURE__*/React.createElement(FirstIcon, null), "\n          "), "\n\n          ", /*#__PURE__*/React.createElement(elements_buttons_index.Button, { className: '!p-2 min-w-0 pointer-events-none', variant: 'default', isDisabled: page === numPages, isSmall: true, onClick: handleClickToNextPage }, "\n            ", page, " ", /*#__PURE__*/React.createElement("span", { className: 'opacity-50' }, "/ ", numPages), "\n          "), "\n          ", /*#__PURE__*/React.createElement(elements_buttons_index.Button, { className: '!p-2 min-w-0 text-primary', variant: 'default', isDisabled: page === numPages, isSmall: true, onClick: handleClickToNextPage }, "\n            ", /*#__PURE__*/React.createElement(NextIcon, null), "\n          "), "\n          ", /*#__PURE__*/React.createElement(elements_buttons_index.Button, { className: '!p-2 min-w-0 text-primary', variant: 'default', isDisabled: page === numPages, isSmall: true, onClick: handleGoToLastPage }, "\n            ", /*#__PURE__*/React.createElement(LastIcon, null), "\n          "), "\n        ")), "\n    "));
}
