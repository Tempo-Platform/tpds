...
const Select = ({ options, handleIndexSelection, idProp, selectedIndex = -1, excludeIndexes = [], noPermanentSelection = false, enableClear = false, labelProp = 'value', placeholder = 'Select', isInvalid = false, forceLightMode = false, useKeyboard = false, className, }) => {
